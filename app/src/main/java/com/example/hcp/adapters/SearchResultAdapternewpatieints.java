...
public class SearchResultAdapternewpatieints extends RecyclerView.Adapter<SearchResultAdapternewpatieints.ViewHolder> {

    private  SearchResultData[] sData;
    private Context context;

    // RecyclerView recyclerView;
    public SearchResultAdapternewpatieints(SearchResultData[] listdata, Context context) {
        this.sData = listdata;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.infoinrow, parent, false);
